...
function Orders() {
  ...
  const fetchOrders = async () => {
    try {
      const res = await fetch("http://menucollection-env.eba-3fhzuumj.eu-north-1.elasticbeanstalk.com/api/orders", {
        headers: {
  ...
  const handleCancelSubmit = async () => {
    ...
    try {
      const res = await fetch(
        `http://menucollection-env.eba-3fhzuumj.eu-north-1.elasticbeanstalk.com/api/orders/${selectedOrder.orderId}/cancel`,
        {
          method: "PUT",
          headers: {
